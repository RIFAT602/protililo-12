        ...
        return (
            <Fragment>
                <Container fluid={true} className="text-center footerSection">
                    <Row>
                        ...
                        <Col lg={3} md={6} sm={12} className="p-5 text-justify">
                            ...
                            <p className="serviceDescription" >#Payab Bora Bari Debidwar,Cumilla</p>
                            <p className="serviceDescription" > <FontAwesomeIcon  icon={faEnvelope} /> Engr.mohiuddinrifatbaiust1107024@gmail.com</p>
                            <p className="serviceDescription" > <FontAwesomeIcon  icon={faPhone} /> +8801989579462</p>
                        </Col>
                        <Col lg={3} md={6} sm={12} className="p-5 text-justify">
                ...
                <Container fluid={true} className="text-center copyrightSection">
                    <a className="copyrightLink" href="#">MOHIUDDIN RIFAT &copy; 2019-2020</a>
                </Container>
